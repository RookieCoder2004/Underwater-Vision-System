...
Overview
This project is an AI-based system for detecting underwater debris using YOLOv8. It enhances images based on environmental conditions and performs object detection with pollution scoring.
